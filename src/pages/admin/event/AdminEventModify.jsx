...
import {FiImage, FiInfo, FiTrash2, FiUploadCloud} from "react-icons/fi";
...
import {updateEventApi} from "../../../api/admin/AdminEventApi.js";

export default function AdminEventModify() {
    ...
    return (
        <>
            <main>
                <TitleLabel title={'이벤트 수정'} desc={'이벤트 정보를 수정합니다.'}/>

                <form onSubmit={handleModify} className="mt-8 overflow-hidden rounded-2xl border border-border">
                            ...
                            <div className="space-y-4">
                                ...
                                <div
                                    ...
                                    {bannerPreview ? (
                                        ...
                                        <>
                                            <img src={`${import.meta.env.VITE_API_SERVER}/uploads/${form.posterUrl}`}
                                                 alt={'기존 이벤트 배너'}
                                                 className="absolute inset-0 h-full w-full object-cover"/>
                                        </>
                                    )}
